...
import pandas as pd
try:
    data = np.load('../PointerExperimentData/23_11_ashTrial1_90s.npz') # for siddhi trial 3 the boxes were 60 x 60
except FileNotFoundError:
    data = np.load('Experiment_pointer/PointerExperimentData/23_11_ashTrial1_90s.npz')
